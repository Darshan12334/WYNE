                ...
                {error && (
                    ...
                    >
                        ...
                        <div className="mt-2 text-xs opacity-70">
                            Check if the backend is live at <a href={import.meta.env.VITE_API_BASE_URL || "https://wyne-backend.onrender.com"} target="_blank" rel="noreferrer" className="underline">{import.meta.env.VITE_API_BASE_URL || "https://wyne-backend.onrender.com"}</a>
                        </div>
                    </motion.div>
                )}
